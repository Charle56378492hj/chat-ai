...
const iconMap: Record<string, typeof MessageCircle> = {
  MessageCircle, Send, ShoppingBag, Search,
};
...
const features = [
  ...
  { icon: MessageCircle, title: 'كل القنوات في مكان واحد', desc: 'واتساب وتلغرام — صندوق وارد موحّد.' },
...
const faqs = [
  ...
  { q: 'ما القنوات المدعومة؟', a: 'واتساب وتلغرام فقط.' },
