...
export const env = {
  ...
  // سر مشترك مع Supabase Edge Functions (ai-agent-chat / ai-agent-scheduler)
  // للسماح بإرسال رسائل بدون جلسة متصفح — مطلوب فقط لهذا المسار الداخلي.
  gatewaySecret: process.env.TELEGRAM_GATEWAY_SECRET?.trim() || '',
};
